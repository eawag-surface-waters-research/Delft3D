...
subroutine test_hash_fill
    ...
    call assert_true( allocated(hashlist%hashfirst), "The 'first' array in the hashlist is NOT allocated" )
    ...
    call assert_true( allocated(hashlist%hashnext), "The 'next' array in the hashlist is NOT allocated" )
...
subroutine test_hash_dealloc
    ...
    call assert_false( allocated(hashlist%hashfirst), "The 'first' array has NOT been deallocated" )
    call assert_false( allocated(hashlist%hashnext), "The 'next' array has NOT been deallocated" )
...
subroutine test_hash_search_or_add
    ...
    idxn = hashsearch( hashlist, 'FOO' )
    call assert_equal( idx1, idxn, "The retrieval is case-sensitive" )
