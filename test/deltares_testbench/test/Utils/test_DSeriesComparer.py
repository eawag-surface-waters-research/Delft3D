...
class TestDSeriesComparer():
    ...
    def test_buildTrees(self):
        ...
        output = reftree[0]['DUMPFILE'][0]['DUMPFILE OUTPUT'][0]['VERIFICATION RESULTS'][0]['GLOBAL NEN RESULTS'][0] \
                 == {'block_start': [1474], 'block_end': [1479],
                     'txt': ['0.063203 = wd1B', '0.009173 = Betad1B', '0.024783 = w2d', '0.003441 = Betad2']}
    ...
    def test_branch(self):
        ...
        testbranch = {'block_start': [10],
                      'block_end': [35],
                      'NEN AVERAGE PILE FACTORS': [{'block_start': [11],
                                                    'block_end': [26],
                                                    'TABLE': [{'block_start': [12],
                                                               'block_end': [25],
                                                               'COLUMN INDICATION': [{'block_start': [13],
                                                                                      'block_end': [19],
                                                                                      'txt': ['CptIndex',
                                                                                              'AlphaSGemSg',
                                                                                              'AlphaSGemClp',
                                                               ...
                                                               'DATA': [{'block_start': [20],
                                                                         'block_end': [24],
                                                                         'txt': ['1  0.0060  0.0000  0.8000',
                                                                                 '2  0.0060  0.0200  0.8000',
                                                                                 '3  0.0060  0.0000  0.8000']}]}]}],
                      'txt': [''],
                      'CALCULATION PARAMETERS BEARING PILES EC 7': [{'block_start': [28],
                                                                     'block_end': [34],
                                                                     'txt': ['Ksi3Used = 1.3000',
                                                                             'Ksi4Used = 1.3000',
                                                                             'GammaBUsed = 1.2000',
    ...
    def test_branch_Exception(self):
        ...
        error = 'FILE ENDED in [Test]-section, started on line 9,\n  ' \
