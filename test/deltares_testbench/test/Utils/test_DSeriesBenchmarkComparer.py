...
class TestDSeriesBenchmarkComparer:
    def setup_method(self):
        ...
        settings.local_paths, settings.programs, settings.configs = \
            xmlcp.load(join(self.testdata, 'Unit_test.xml'), '', c)
    ...
    def test_compare(self):
        ...
        param_results = DSeriesBenchmarkComparer.compare(self.comp, self.lp, self.rp, self.file_check, testcase_name)
        ...
        test = ['>DUMPFILE>DUMPFILE OUTPUT>VERIFICATION RESULTS>NEN PILE RESULTS>MAX SHAFT AND POINT>TABLE|MaxShaft::1',
        ...
        for parameter in param_results:
            if parameter[3].result != 'OK':
                output = False
            if parameter[2].getName() not in test:
                output = False
    ...
    def test_compareBenchmark_OK(self):
        ...
        varlist = [{'variable': 'MaxShaft::1', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 1.},
                   {'variable': 'MaxPoint::1', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 2.},
                   {'variable': 'MaxShaft::2', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 3.},
                   {'variable': 'MaxPoint::2', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 4.},
                   {'variable': 'MaxShaft::3', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 5.},
                   {'variable': 'MaxPoint::3', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 6.},
                   {'variable': 'Parameter1', 'path': '>DUMPFILE>CALCULATION PARAMETERS', 'value': 1.3},
                   {'variable': 'Parameter2', 'path': '>DUMPFILE>CALCULATION PARAMETERS', 'value': 1.4},
        ...
        # The output
        testoutput = {'>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxShaft::1': {'valueOK': 'OK',
                                                                          'result value': 1.,
                                                                          'benchmark value': 1.,
                      ...
                      '>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxPoint::1': {'valueOK': 'OK',
                                                                          'result value': 2.,
                                                                          'benchmark value': 2.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': 0.0,
                                                                          'absolute difference': 0.0},
                      '>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxShaft::2': {'valueOK': 'OK',
                                                                          'result value': 3.,
                                                                          'benchmark value': 3.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': 0.0,
                                                                          'absolute difference': 0.0},
                      '>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxPoint::2': {'valueOK': 'OK',
                                                                          'result value': 4.,
                                                                          'benchmark value': 4.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': 0.0,
                                                                          'absolute difference': 0.0},
                      '>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxShaft::3': {'valueOK': 'OK',
                                                                          'result value': 5.,
                                                                          'benchmark value': 5.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': 0.0,
                                                                          'absolute difference': 0.0},
                      '>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxPoint::3': {'valueOK': 'OK',
                                                                          'result value': 6.,
                                                                          'benchmark value': 6.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': 0.0,
                                                                          'absolute difference': 0.0},
                      '>DUMPFILE>CALCULATION PARAMETERS|Parameter1': {'valueOK': 'OK',
                                                                      'result value': 1.3,
                                                                      'benchmark value': 1.3,
                                                                      'relative tolerance': 0.0005,
                                                                      'absolute tolerance': 0.0005,
                                                                      'relative difference': 0.0,
                                                                      'absolute difference': 0.0},
                      '>DUMPFILE>CALCULATION PARAMETERS|Parameter2': {'valueOK': 'OK',
                                                                      'result value': 1.4,
                                                                      'benchmark value': 1.4,
                                                                      'relative tolerance': 0.0005,
                                                                      'absolute tolerance': 0.0005,
                                                                      'relative difference': 0.0,
                                                                      'absolute difference': 0.0},
                      '>DUMPFILE>DEMANDS|Parameter3': {'valueOK': 'OK',
                                                       'result value': 0.06,
                                                       ...
                                                       'relative difference': 0.0,
                                                       'absolute difference': 0.0},
                      '>DUMPFILE>DEMANDS|Parameter4': {'valueOK': 'OK',
                                                       'result value': 0.02,
    ...
    def test_compareBenchmark_NOK(self):
        # Set inputs in this case there should be no errors
        # Define the variable list as a dictionary
        varlist = [{'variable': 'MaxShaft::1', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 999.},
                   {'variable': 'MaxPoint::1', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 999.},
                   {'variable': 'MaxShaft::2', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 999.},
                   {'variable': 'MaxPoint::2', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 999.},
                   {'variable': 'MaxShaft::3', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 999.},
                   {'variable': 'MaxPoint::3', 'path': '>DUMPFILE>MAX SHAFT AND POINT>TABLE', 'value': 999.},
                   {'variable': 'Parameter1', 'path': '>DUMPFILE>CALCULATION PARAMETERS', 'value': 999.},
                   {'variable': 'Parameter2', 'path': '>DUMPFILE>CALCULATION PARAMETERS', 'value': 999.},
                   {'variable': 'Parameter3', 'path': '>DUMPFILE>DEMANDS', 'value': 999.},
                   {'variable': 'Parameter4', 'path': '>DUMPFILE>DEMANDS', 'value': 999.}]
        # Inputs of path and file
        testcase = 'comparebenchmarks.fod'
        ...
        # The output
        testoutput = {'>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxShaft::1': {'valueOK': 'NOK',
                                                                          'result value': 1.,
                                                                          'benchmark value': 999.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': (999. - 1.) / 999.,
                                                                          'absolute difference': 999. - 1.},
                      '>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxPoint::1': {'valueOK': 'NOK',
                                                                          'result value': 2.,
                                                                          'benchmark value': 999.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': (999. - 2.) / 999.,
                                                                          'absolute difference': 999. - 2.},
                      '>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxShaft::2': {'valueOK': 'NOK',
                                                                          'result value': 3.,
                                                                          'benchmark value': 999.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': (999. - 3.) / 999.,
                                                                          'absolute difference': 999. - 3.},
                      '>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxPoint::2': {'valueOK': 'NOK',
                                                                          'result value': 4.,
                                                                          'benchmark value': 999.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': (999. - 4.) / 999.,
                                                                          'absolute difference': 999. - 4.},
                      '>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxShaft::3': {'valueOK': 'NOK',
                                                                          'result value': 5.,
                                                                          'benchmark value': 999.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': (999. - 5.) / 999.,
                                                                          'absolute difference': 999. - 5.},
                      '>DUMPFILE>MAX SHAFT AND POINT>TABLE|MaxPoint::3': {'valueOK': 'NOK',
                                                                          'result value': 6.,
                                                                          'benchmark value': 999.,
                                                                          'relative tolerance': 0.0005,
                                                                          'absolute tolerance': 0.0005,
                                                                          'relative difference': (999. - 6.) / 999.,
                                                                          'absolute difference': 999. - 6.},
                      '>DUMPFILE>CALCULATION PARAMETERS|Parameter1': {'valueOK': 'NOK',
                                                                      'result value': 1.3,
                                                                      'benchmark value': 999.,
                                                                      'relative tolerance': 0.0005,
                                                                      'absolute tolerance': 0.0005,
                                                                      'relative difference': (999. - 1.3) / 999.,
                                                                      'absolute difference': 999. - 1.3},
                      '>DUMPFILE>CALCULATION PARAMETERS|Parameter2': {'valueOK': 'NOK',
                                                                      'result value': 1.4,
                                                                      'benchmark value': 999.,
                                                                      'relative tolerance': 0.0005,
                                                                      'absolute tolerance': 0.0005,
                                                                      'relative difference': (999. - 1.4) / 999.,
                                                                      'absolute difference': 999. - 1.4},
                      '>DUMPFILE>DEMANDS|Parameter3': {'valueOK': 'NOK',
                                                       'result value': 0.06,
                                                       'benchmark value': 999.,
                                                       'relative tolerance': 0.0005,
                                                       'absolute tolerance': 0.0005,
                                                       'relative difference': (999. - 0.06) / 999.,
                                                       'absolute difference': 999. - 0.06},
                      '>DUMPFILE>DEMANDS|Parameter4': {'valueOK': 'NOK',
                                                       'result value': 0.02,
                                                       'benchmark value': 999.,
                                                       'relative tolerance': 0.0005,
                                                       'absolute tolerance': 0.0005,
                                                       'relative difference': (999. - 0.02) / 999.,
                                                       'absolute difference': 999. - 0.02}}
    ...
    def test_compare_empty(self):
        ...
        xmlcp = XmlConfigParser()
        settings.local_paths, settings.programs, settings.configs = \
            xmlcp.load(join(self.testdata, "Unit_test_empty_file.xml"), '', c)
        file = settings.configs
        ...
        shutil.copy2(join(self.testdata, 'Unit_test_empty.csv'), join(self.lp, 'Unit_test_empty.csv'))
        shutil.copy2(join(self.testdata, 'Unit_test_empty.csv'), join(self.rp, 'Unit_test_empty.csv'))

        # Run the file for catching the exceptions
        with pytest.raises(Exception) as context:
            DSeriesBenchmarkComparer.compare(self.comp, self.lp, self.rp, file_check, testcase_name)
    ...
    def test_parse_params(self):
        ...
        vartest = [{'variable': 'ValueName::1', 'path': '>THIS>IS>THE>PATH', 'value': 999.},
                   {'variable': 'ValueName', 'path': '>THIS>IS>THE>PATH', 'value': 999., 'absTol': 0.5},
                   {'variable': 'ValueName::1', 'path': '>THIS>IS>THE>PATH', 'value': -999.}]
    ...
    def test_split_lines_ignoring_quotes(self):
        dsbc = DSeriesBenchmarkComparer()
        assert ['Sand', 'Clay', 'Peat'] == DSeriesBenchmarkComparer.split_lines_ignoring_quotes(dsbc, 'Sand,Clay,Peat')
        assert ['Sand', '"Clay,Peat"'] == DSeriesBenchmarkComparer.split_lines_ignoring_quotes(dsbc, 'Sand,"Clay,Peat"')
