flowexedir       = ../../../src/bin/lnx64/dflow2d3d/bin
flowargs         = config_d_hydro.xml
waveexedir       = ../../../src/bin/lnx64/dwaves/bin
waveargs         = bas.mdw 1
swanbatdir       = ../../../src/bin/lnx64/swan/scripts
mormergeexedir   = ../../../src/bin/lnx64/dflow2d3d/bin
nodes            = local
# nodes            = 1
debug            = 0
# workdir          = /temp
