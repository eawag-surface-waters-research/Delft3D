 ...
 */
typedef void (STDCALL *SwapBuffersCallback_pf)(ArbParam_t PageClientData,
                                               ArbParam_t RegistrationClientData);
 ...
 *   Client data that was registered with the callback.
 */
typedef void (STDCALL *EngineNotBusyCallback_pf)(ArbParam_t RegistrationClientData);
 ...
 * @sa TecEngStatusLineRegisterCallback
 */
typedef void (STDCALL *ShowRunningCoordinatesCallback_pf)(const char* firstCoordText,
...
/* - NO DOXYGEN COMMENT GENERATION -
 * This callback will be used by the engine to query the parent's app
 ...
 *   Client data that was registered with the callback.
 * @return
 *   The parent's app OpenGL version string. The caller of this function
 *   is responsible for freeing the memory allocated to hold the string.
 *
 ...
 * </FortranSyntax>
 */
typedef Boolean_t (STDCALL *DataLoader_pf)(StringList_pa Instructions,
                                           ArbParam_t    ClientData);

/**
 * Data loader V1 (legacy data loader) callbacks have no parameters.
 */
typedef DynamicMenuCallback_pf DataLoaderSelectedV1Callback_pf;
 ...
 */
typedef void (STDCALL * DataLoaderSelectedV2Callback_pf)(
 ...
 *   Pointer to custom data
 */
typedef void (STDCALL * DataLoaderSelectedV3Callback_pf)(
    StringList_pa SelectedFiles,
    Boolean_t     AdvancedOptionsSelected,
    ArbParam_t    ClientData);
 ...
 *
 */
typedef Boolean_t (STDCALL *DataLoaderInstructionOverride_pf)(StringList_pa Instructions,
                                                              ArbParam_t    ClientData);
 ...
 */
typedef Boolean_t (STDCALL * DataWriterSelectedCallback_pf)(const char*   SelectedFile,
                                                            ArbParam_t    ClientData);
