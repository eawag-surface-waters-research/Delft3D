#ifndef TECPLOT_tpsdkbase_EXPORTS_H
#define TECPLOT_tpsdkbase_EXPORTS_H
...
#if defined _WIN32
    #define tpsdkbase_HELPER_DLL_IMPORT __declspec(dllimport)
    #define tpsdkbase_HELPER_DLL_EXPORT __declspec(dllexport)
    #define tpsdkbase_HELPER_DLL_LOCAL
#else
    #if __GNUC__ >= 4
        #define tpsdkbase_HELPER_DLL_IMPORT __attribute__ ((visibility("default")))
        #define tpsdkbase_HELPER_DLL_EXPORT __attribute__ ((visibility("default")))
        #define tpsdkbase_HELPER_DLL_LOCAL  __attribute__ ((visibility("hidden")))
    #else
        #define tpsdkbase_HELPER_DLL_IMPORT
        #define tpsdkbase_HELPER_DLL_EXPORT
        #define tpsdkbase_HELPER_DLL_LOCAL
    #endif
#endif
 ...
 */
#ifdef tpsdkbase_EXPORTS // defined if we are building the tpsdkbase code (instead of using it)
  #define tpsdkbase_API tpsdkbase_HELPER_DLL_EXPORT
#else
  #define tpsdkbase_API tpsdkbase_HELPER_DLL_IMPORT
#endif // tpsdkbase_EXPORTS
#define tpsdkbase_LOCAL tpsdkbase_HELPER_DLL_LOCAL
 ...
 */
#if defined _WIN32
    #define tpsdkbase_FORCE_EXPORT(ClassName) class tpsdkbase_API ClassName
#else
    #define tpsdkbase_FORCE_EXPORT(ClassName)
#endif
