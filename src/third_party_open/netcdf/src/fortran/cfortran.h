...
#if defined(CLIPPERFortran) || defined(pgiFortran) || defined(gFortran) 
#define f2cFortran
#endif

#if defined(__INTEL_COMPILER) || defined(INTEL_COMPILER)
...
/* Split #if into 2 because some HP-UX can't handle long #if */
#if !(defined(NAGf90Fortran)||defined(f2cFortran)||defined(hpuxFortran)||defined(apolloFortran)||defined(sunFortran)||defined(IBMR2Fortran)||defined(CRAYFortran)||defined(INTEL_COMPILER))
#if !(defined(mipsFortran)||defined(DECFortran)||defined(vmsFortran)||defined(CONVEXFortran)||defined(PowerStationFortran)||defined(AbsoftUNIXFortran)||defined(AbsoftProFortran)||defined(SXFortran))
...
#else 
#if defined(CRAYFortran) || defined(PowerStationFortran) || defined(AbsoftProFortran) || defined(INTEL_COMPILER)
...
#ifndef INTEL_COMPILER   /* versions earlier use the visual compaq */
#define FCALLSC_QUALIFIER __stdcall
#else /* newer versions use the intel fortran with c calling convention */
#define FCALLSC_QUALIFIER __cdecl
#endif
#else
