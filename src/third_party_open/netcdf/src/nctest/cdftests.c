 ...
 *   $Header: /upc/share/CVS/netcdf-3/nctest/cdftests.c,v 1.20 2005/11/05 15:54:28 ed Exp $
 *********************************************************************/
     ...
     const char *path;		/* name of writable netcdf file to open */
{
     ...
     * directory, and consequently, make dist. An object file is safe,
     * since the test is run in the directory it's built in.
     */
    if((ncid0 = ncopen("driver.o", NC_NOWRITE)) != -1) {
