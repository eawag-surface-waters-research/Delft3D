   ...
   function nf90_put_var_FourByteInt(ncid, varid, values, start)
     ...
     nf90_put_var_FourByteInt = nf_put_var1_int(ncid, varid, localIndex, values)
   ...
   function nf90_put_var_EightByteInt(ncid, varid, values, start)
     ...
     nf90_put_var_EightByteInt = nf_put_var1_int(ncid, varid, localIndex, values)
   ...
   function nf90_put_var_1D_FourByteInt(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_1D_FourByteInt = &
          nf_put_varm_int(ncid, varid, localStart, localCount, localStride, localMap, values)
     else if(present(stride)) then
       nf90_put_var_1D_FourByteInt = &
          nf_put_vars_int(ncid, varid, localStart, localCount, localStride, values)
     else
       nf90_put_var_1D_FourByteInt = &
   ...
   function nf90_get_var_1D_FourByteInt(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_1D_FourByteInt = &
          nf_get_varm_int(ncid, varid, localStart, localCount, localStride, localMap, values)!defaultIntArray)
     else if(present(stride)) then
       nf90_get_var_1D_FourByteInt = &
          nf_get_vars_int(ncid, varid, localStart, localCount, localStride, values)!defaultIntArray)
     else
       nf90_get_var_1D_FourByteInt = &
          nf_get_vara_int(ncid, varid, localStart, localCount, values)!defaultIntArray)
     end if
