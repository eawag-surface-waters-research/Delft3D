% MEXNC-DOC:  type "help mexnc-doc" for mexnc interface information
...
%
% WIN32_MAKE_MEXNC:  Build Single-Threaded and Multi-Threaded versions 
%     of mexnc for win32 with NetCDF 3.6.0 (w/large file support)  
