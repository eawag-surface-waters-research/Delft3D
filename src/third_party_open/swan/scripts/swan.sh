...
################################################################################
if [ $mpirun -eq 1 ]; then
  SWANEXEC=${D3D_HOME}/third_party_open/swan/bin/linux/swan_4081_del_l32_i11_mpi.exe
else
  SWANEXEC=${D3D_HOME}/third_party_open/swan/bin/linux/swan_4081_del_l32_i11_omp.exe
  #
