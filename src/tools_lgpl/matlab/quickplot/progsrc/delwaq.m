...
elseif ischar(Fl)
    ...
    if ischar(Inp{1})
        switch lower(Inp{1}),
            case {'pcwin','pcwin64','pc','sun4','sol2','hp700','hpux', ...
                    'sgi','sgi64','ibm_rs','unix','glnx86','glnxa64'}
                Format=Inp{1};
                j=j+1;
            otherwise
                Format=computer;
    ...
    switch lower(Format)
        case {'pcwin','pcwin64','pc','glnx86','glnxa64'}
            S.ByteOrder='l';
            S.FormatType='binary';
        case {'sun4','sol2','hp700','hpux','sgi','sgi64','ibm_rs','unix'}
            S.ByteOrder='b';
