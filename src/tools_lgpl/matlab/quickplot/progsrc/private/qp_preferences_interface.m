...
if ~isempty(depdir)
    ...
    handles(end+1)=uicontrol('style','edit', ...
        'position',[HOffset VOffset 290-Margin 20], ...
        'string',depdir, ...
        'horizontalalignment','left', ...
        'enable','inactive', ...
        'parent',mfig);
...
VOffset = VOffset-25;
handles(end+1)=uicontrol('style','text', ...
    'position',[HOffset+38 VOffset-2 150 18], ...
...
VOffset = VOffset-25;
handles(end+1)=uicontrol('style','edit', ...
    'position',[HOffset+38 VOffset-2 dims(2)-58 20], ...
    'backgroundcolor',get(mfig,'color'), ...
    'horizontalalignment','left', ...
    'enable','off', ...
    'tag','defaultfigure', ...
...
uicontrol('style','pushbutton', ...
    'position',[dims(1)-60 Margin 50 20], ...
    'string','OK', ...
    'callback','closereq', ...
    'parent',mfig);
%=============
