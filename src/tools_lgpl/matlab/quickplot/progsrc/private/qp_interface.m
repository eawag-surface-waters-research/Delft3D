...
voffset=voffset-25;
h1 = LocButton(mfig,[offset+50 voffset width-50 20],'exportdata','Export Data...',0, ...
...
PMsize = [425 205];
PMsizeMin = [];
pos=[qp_settings('PlotMngrPositionUL',screensize(3:4)/2+[-210 100]) PMsize];
pos(2)=pos(2)-pos(4);
%
...
setappdata(PM.Fig,'MinimumFigureSize',[305 125]);
%=============
...
PM.FigTxt = uicontrol('Parent',PM.Fig, ...
    'Position',[10 180 40 17], ...
    'Style','text', ...
    'Horizontalalignment','left', ...
    'String','Figure');
PM.FigList = uicontrol('Parent',PM.Fig, ...
    'Position',[60 180 320 20], ...
    'String',{' '}, ...
    'Style','popupmenu', ...
    'Tag','selectfigure', ...
...
PM.AxTxt = uicontrol('Parent',PM.Fig, ...
    'Position',[10 150 40 17], ...
    'Style','text', ...
    'Horizontalalignment','left', ...
    'String','Axes');
PM.AxList = uicontrol('Parent',PM.Fig, ...
    'Position',[60 150 320 20], ...
    'String',' ', ...
    'Style','popupmenu', ...
    'Tag','selectaxes', ...
