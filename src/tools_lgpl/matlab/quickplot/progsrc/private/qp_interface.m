...
offset=PMsize(1)-panewidth;
% width=panewidth-36;
line(offset+[1 1],[0 PMsize(2)],[0 0],'color',[1 1 1],'parent',PM.Separator);
line(offset+[0 0],[0 PMsize(2)],[0 0],'color',[128 128 128]/255,'parent',PM.Separator);
%
Top = PMsize(2)-10;
...
PM.ItTxt2 = uicontrol('Parent',PM.Fig, ...
    ...
    'Horizontalalignment','left', ...
    'String','Item');
PM.ItHandles = [PM.ItTxt2 PM.ItList2];
PM.Handles = [PM.Handles PM.ItHandles];
PM.Pane(end+1:length(PM.Handles)) = {'Item Properties'};
%
