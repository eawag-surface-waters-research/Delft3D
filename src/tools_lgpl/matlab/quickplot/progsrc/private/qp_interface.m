...
PM.YLimitMin = uicontrol('Parent',PM.Fig, ...
    'Position',[60 Top-260 60 20], ...
    'Style','edit', ...
    'Horizontalalignment','right', ...
    'Callback','d3d_qp axeslimits', ...
    'Enable','off');
PM.YLimitMax = uicontrol('Parent',PM.Fig, ...
    'Position',[130 Top-260 60 20], ...
    'Style','edit', ...
    'Horizontalalignment','right', ...
    'Callback','d3d_qp axeslimits', ...
    'Enable','off');
PM.YScale = uicontrol('Parent',PM.Fig, ...
    'Position',[200 Top-260 60 20], ...
    'Style','popupmenu', ...
    'Horizontalalignment','left', ...
    'Enable','off', ...
    'Callback','d3d_qp axesscale', ...
...
PM.ZLimitMin = uicontrol('Parent',PM.Fig, ...
    'Position',[60 Top-320 60 20], ...
    'Style','edit', ...
    'Horizontalalignment','right', ...
    'Callback','d3d_qp axeslimits', ...
    'Enable','off');
PM.ZLimitMax = uicontrol('Parent',PM.Fig, ...
    'Position',[130 Top-320 60 20], ...
    'Style','edit', ...
    'Horizontalalignment','right', ...
    'Callback','d3d_qp axeslimits', ...
    'Enable','off');
PM.ZScale = uicontrol('Parent',PM.Fig, ...
    'Position',[200 Top-320 60 20], ...
    'Style','popupmenu', ...
    'Horizontalalignment','left', ...
    'Enable','off', ...
    'Callback','d3d_qp axesscale', ...
