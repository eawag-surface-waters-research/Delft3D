...
h1 = LocTextEdit_pair(mfig,'Thresholds','thresholds','',[offset voffset width 20], ...
    {'Specify thresholds/contour values:','specify the number, e.g. 15 (default 10),','or the values, e.g. 0:0.5:3 4:6'});
voffset=voffset-25;
h1 = uicontrol('Parent',mfig, ...
    'Enable','off', ...
    'Position',[offset voffset width 20], ...
...
pos(2)=pos(2)-pos(4);
%
Arrow=repmat(reshape(UD.Inactive,[1 1 3]),[16,16,1]);
Arrow(8:14,7:10,:)=0.5;
for i=1:6, Arrow(2+i,(9-i):(8+i),:)=0.5; end;
%
PM.CurrentAxes = [];
...
PM.AxBox = uicontrol('Parent',PM.Fig, ...
    ...
    'Enable','off');
%
PM.GridTxt = uicontrol('Parent',PM.Fig, ...
    'Position',[200 Top-110 60 17], ...
    'Style','text', ...
    'Horizontalalignment','left', ...
    'String','Grid');
PM.XGrid = uicontrol('Parent',PM.Fig, ...
    'Position',[270 Top-110 60 17], ...
    'Style','checkbox', ...
    'Horizontalalignment','left', ...
    'Enable','off', ...
...
PM.AxPosUnit = uicontrol('Parent',PM.Fig, ...
    ...
    'String',{'cm' 'inch' '%page'});
PM.Handles = [PM.Handles PM.AxColorTxt PM.AxColor PM.AxBox ...
    PM.XLimitTxt PM.XLimitMin PM.XLimitMax PM.YLimitTxt PM.YLimitMin ...
    PM.YLimitMax PM.GridTxt PM.XGrid PM.YGrid PM.AxPosition ...
    PM.AxXLowerLeft PM.AxYLowerLeft PM.AxWidth PM.AxHeight PM.AxPosUnit];
