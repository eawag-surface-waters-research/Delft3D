...
PM.FigPaperWidth = uicontrol('Parent',PM.Fig, ...
    'Position',[LeftS Top-140 WidthS 20], ...
    'Style','edit', ...
    'Callback','d3d_qp figurepapertype', ...
    'String','', ...
    'Enable','off');
PM.FigPaperX = uicontrol('Parent',PM.Fig, ...
    'Position',[LeftS+WidthS Top-140 20 17], ...
    'Style','text', ...
    'String','x', ...
    'Horizontalalignment','center', ...
    'Enable','off');
PM.FigPaperHeight = uicontrol('Parent',PM.Fig, ...
    'Position',[RightS-WidthS Top-140 WidthS 20], ...
    'Style','edit', ...
    'Callback','d3d_qp figurepapertype', ...
    'String','', ...
    'Enable','off');
PM.FigPaperUnit = uicontrol('Parent',PM.Fig, ...
    'Position',[Left6+Margin Top-140 Right7-Left6-Margin 20], ...
    'Style','popupmenu', ...
...
PM.FigSmoothing = uicontrol('Parent',PM.Fig, ...
    'Position',[Left6+Margin Top-200 Right7-Left6-Margin 20], ...
    'Style','checkbox', ...
