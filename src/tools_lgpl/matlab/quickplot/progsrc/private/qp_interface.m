...
PM.FigBorder = uicontrol('Parent',PM.Fig, ...
    ...
    'Enable','off');
PM.Handles = [PM.Handles ...
    PM.FigNameTxt PM.FigName PM.FigColorTxt PM.FigColor ...
...
PM.ZLabel = uicontrol('Parent',PM.Fig, ...
    'Position',[130 Top-380 270 20], ...
    'Style','edit', ...
    'Horizontalalignment','left', ...
    'Callback','d3d_qp zlabel', ...
    'Enable','off');
PM.Handles = [PM.Handles ...
    PM.AxNameTxt PM.AxName PM.AxTypeTxt PM.AxType ...
    PM.AxTitleTxt PM.AxTitleAuto PM.AxTitle ...
    PM.AxColorTxt PM.HasAxColor PM.AxColor PM.AxBox  ...
