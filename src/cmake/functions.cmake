...
function(generate_version_files fortran_version_file version_file) 
    ...
    if (WIN32)
        ...
        IF(DEFINED ARGV3 AND ARGV3)
            execute_process(COMMAND ${update_version_script_path} ${fortran_version_file} ${checkout_src_root} ${version_file} ${CMAKE_BINARY_DIR} --onlyifmissing)
        ELSE()
            execute_process(COMMAND ${update_version_script_path} ${fortran_version_file} ${checkout_src_root} ${version_file} ${CMAKE_BINARY_DIR})
        ENDIF()
    endif(WIN32)
