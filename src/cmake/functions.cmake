...
function(generate_version_files fortran_version_file svn_version_path version_file) 
    ...
    if (UNIX)
        message(STATUS "generate_version_files on Linux  ${update_version_script_path} ${fortran_version_file} ${svn_version_path} ${version_file} ${svn_version_path}")
    ...
    if (WIN32)
        message(STATUS "generate_version_files on Windows")
