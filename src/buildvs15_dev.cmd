...
devenv.com delft3d_open.sln /Build "Release|x64" /Out build_delft3d_open.log
if NOT %ErrorLevel% EQU 0 (
...
devenv.com dflowfm_open.sln /Build "Release|x64" /Out build_dflowfm_open.log
if NOT %ErrorLevel% EQU 0 (
...
rem ===========================================================================
rem io_netcdf.sln
devenv.com io_netcdf.sln /Build "Release|x64" /Out build_io_netcdf.log
if NOT %ErrorLevel% EQU 0 (
    echo "Error in compiling delft3d_open.sln: %ErrorLevel%"
    set globalErrorLevel=%ErrorLevel%
)
...
rem ===========================================================================
rem nefis.sln
devenv.com nefis.sln /Build "Release|x64" /Out build_nefis.log
if NOT %ErrorLevel% EQU 0 (
    echo "Error in compiling delft3d_open.sln: %ErrorLevel%"
    set globalErrorLevel=%ErrorLevel%
)
