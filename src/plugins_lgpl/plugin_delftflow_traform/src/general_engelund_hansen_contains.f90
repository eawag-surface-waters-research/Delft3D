...
!  
!  
subroutine general_enghan_contains(dll_integers, max_integers, &
                  dll_reals   , max_reals   , &
                  dll_strings , max_strings , &
                  sbc_total, sbc  , sbcu, sbcv, sbwu, sbwv     , &
                  equi_conc, cesus, ssus, sswu, sswv, t_relax  , &
                  error_message_c   )
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS: 'GEN_ENGHAN_C' :: GENERAL_ENGHAN_CONTAINS
!!--description-----------------------------------------------------------------
!
...
end subroutine general_enghan_contains
