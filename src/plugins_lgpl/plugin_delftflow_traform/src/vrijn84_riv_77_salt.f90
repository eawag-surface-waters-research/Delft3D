...
tracf1  = dll_reals(31)    ! Salinity modification velocity [m/s]
tracf2  = dll_reals(32)     ! Salinity modification factor 1
tracf3  = dll_reals(33)     ! Salinity modification factor 2
tracf4  = dll_reals(34)     ! Salinity modification factor 3
!
