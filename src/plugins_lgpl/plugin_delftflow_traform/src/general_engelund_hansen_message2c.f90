...
!  
!  
subroutine general_enghan_message2c(dll_integers, max_integers, &
                  dll_reals   , max_reals   , &
                  dll_strings , max_strings , &
                  sbc_total, sbc  , sbcu, sbcv, sbwu, sbwv     , &
                  equi_conc, cesus, ssus, sswu, sswv, t_relax  , &
                  error_message_c   )
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS: 'GEN_ENGHAN_M2C' :: GENERAL_ENGHAN_MESSAGE2C
!!--description-----------------------------------------------------------------
!
...
end subroutine general_enghan_message2c
