...
rem ===========================================================================
rem tests.sln
"%VS2017INSTALLDIR%\Common7\IDE\devenv.com" tests.sln /Build "Release|x64" /Out build_tests.log
if NOT %ErrorLevel% EQU 0 (
    echo "Error in compiling tests.sln: %ErrorLevel%"
    set globalErrorLevel=%ErrorLevel%
)
...
third_party_open\commandline\bin\win32\sed.exe -e "/[Ee]rror[\:\ ]/s/^/\#\#teamcity\[buildStatus status\=\'FAILURE\' text\=\' /g;/buildStatus/s/$/\'\]/g" build_tests.log 
