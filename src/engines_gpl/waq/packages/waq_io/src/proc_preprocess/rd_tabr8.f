...
C
C     FUNCTION           :  Read TABLE_R8 group from NEFIS file
C
...
C     NO_DSTO_MAX  INT            I       maximum number of rows in table R8
C     NO_DSTO      INT            O       number of rows in table R8
C     R8_DID       CHA*10 NO_DSTO O       velocity identification
C     R8_SID       CHA*10 NO_DSTO O       substance identification
C     R8_SCAL      REAL   NO_DSTO O       scale factor
