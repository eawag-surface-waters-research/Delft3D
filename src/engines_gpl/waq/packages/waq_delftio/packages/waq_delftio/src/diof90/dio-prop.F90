...
module waq_dio_prop
       ...
       type waq_arrayProp
           ...
           integer                                           :: no_arrLines
       end type waq_arrayProp

       type (waq_arrayProp), dimension(max_arrayProps)           :: arrProp
       ...
       !
       interface waq_prop_get_1d_array
          module procedure prop_get_1d_array_integer
       end interface

       interface waq_prop_get_2d_array
...
!
        ...
        if ( length .eq. 0 ) then
           ...
           if ( .not. waq_prop_read_array(value, arrPropIndex(propPos)) ) then
              deallocate(value)
              nullify(value)
           endif
        endif
