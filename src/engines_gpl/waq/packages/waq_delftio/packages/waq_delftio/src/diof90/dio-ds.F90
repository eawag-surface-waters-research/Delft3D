...
type waq_DioDsType
    ...
    !
    type(waq_DioStreamType)           :: inStream        ! stream for dataset
    type(waq_DioStreamType)           :: outStream       ! stream for dataset

end type waq_DioDsType
...
interface waq_DioDsCreate
    module procedure waq_DioDsCreate
...
function waq_DioDsCreate(name) result(ds)
    ...
    call waq_DioConfGetDsProp(name, dio_ds_StartTime   , ds % startTimeStr)
    call waq_DioConfGetDsProp(name, dio_ds_DeltaTime   , ds % deltaT)
    ...
    call waq_DioConfGetDsProp(name, dio_ds_HisTimeUnit, ds % hisTimeUnit)
    call waq_DioConfGetDsProp(name, dio_ds_hisTimeMult, ds % hisTimeMult)
...
function DioDsSetTimeFromT0String(ds, T0String) result(retVal)
    ...
    type(waq_DioDsType), target     :: ds              ! dataset
