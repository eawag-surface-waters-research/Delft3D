...
99820 FORMAT (1X,'Invalid species name',2X,A10)
99810 FORMAT (' Valid species names are: ',/,1X,10(1X,A10))
99800 FORMAT(1X,'Incorrect type number ',I1,' for species',1X,A10)
...
99760 FORMAT (1X,A10,20(2X,F7.4))
99750 FORMAT (' Consumer''s preference for phytoplankton species:')
99740 FORMAT (' Coeff. ',A10,' values: ',F7.4,19(2X,F7.4))
      RETURN
      END
