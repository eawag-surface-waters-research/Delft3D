...
!
!  *********************************************************************
!  * SUBROUTINE PROMPT TO WRITE PROMPTING MESSAGES FOR AN              *
!  *                     INTERACTIVE RUN                               *
!  *********************************************************************
!
!  0895 MvdV Addition of prompts for input related to grazing subroutine
...
3000  NDX = INDEX - 1000
     ...
     X      1101,1102,1103,1104,1105),NDX
3001  RETURN
!
...
!
!      0895 MvdV Start additional prompts for input related to grazing
!                subroutine CONSBL
!
...
2104   FORMAT(' Carbon to dry weight ratio: ')
       RETURN
!
1105   WRITE(OUTSTR,2105)
2105   FORMAT(' Selected segment for dump: ')
       RETURN       
!
       END
