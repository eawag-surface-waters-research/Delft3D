...
! CURRENT CAN BE A NUMBER, (, OR FUNCTION
...
!
! PREVIOUS TOKEN WAS A )
! CURRENT CAN BE A ) OR ARITHMETIC OPERATOR
312   IF (ITYPE.EQ.2) GOTO 322
      IF (ITYPE.EQ.3) GOTO 323
      GOTO 400
!
! PREVIOUS TOKEN WAS AN ARITHMETIC OPERATOR
! CURRENT CAN BE A NUMBER, (, OR FUNCTION
...
325   PRVOP = 5
      ...
      GOTO 300
!
! AN ERROR HAS OCCURRED; SET RETURN CODE
