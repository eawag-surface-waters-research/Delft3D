...
C pCO2water      R*4 1 O  partial pressure of CO2 in water               [µatm]
...
C ATMTOMICROATM  R*4 1 L  conversion from atm to µatm                    [atm/µatm]
...
C FCO2           R*4 1 L  fugacity of CO2                                [µatm]
...
C Calculation of fugacity of CO2. Dickson (2007). [µatm]
...
C Calculation of pCO2 in water. Dickson 2007. [µatm]
