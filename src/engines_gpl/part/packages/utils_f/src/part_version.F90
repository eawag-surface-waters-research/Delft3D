...
implicit none
    ...
    character(*),  public, parameter :: part_major        = 'VN_MAJOR'
    character(*),  public, parameter :: part_minor        = 'VN_MINOR'
    character(*),  public, parameter :: part_revision     = 'VN_REVISION'
    character(*),  public, parameter :: part_build_number = 'VN_BUILD_NUMBER'
