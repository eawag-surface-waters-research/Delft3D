...
implicit none
    ...
    character(*),  public, parameter :: unstruc_revision     = '41'
    character(*),  public, parameter :: unstruc_build_number = '63792M'
    ...
    character(*),  public, parameter :: unstruc_source_code  = '@(#) $HeadURL$'//char(0)
