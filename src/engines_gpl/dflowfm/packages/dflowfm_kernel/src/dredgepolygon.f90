module fm_polygon_module
!
! This module provides support function for processing polygon data.
!  Original source: https://svn.oss.deltares.nl/repos/delft3d/trunk/src/engines_gpl/flow2d3d/packages/io/src/input/polygon_module.f90
!
!!--module declarations---------------------------------------------------------
...
!
    ...
    if ( .not. associated(polygon_ptr) ) then
       ...
       call write_error(message, unit=mdia)
       return
    endif
    !
