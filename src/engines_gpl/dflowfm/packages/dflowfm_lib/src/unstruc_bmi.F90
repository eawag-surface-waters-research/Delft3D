...
module bmi
  ...
  integer(c_int), parameter :: var_count_compound = 10 ! pumps, weirs, orifices, gates, generalstructures, sourcesinks, dambreak, observations, crosssections, laterals ! TODO: AvD: temp, as long as this is not templated
contains
...
subroutine get_var_name(var_index, c_var_name) bind(C, name="get_var_name")
   ...
   ! var_count:var_count+var_count_compound-1 = compound types (pumps, weirs, orifices, gates, generalstructures, sourcesinks, dambreak, observations, crosssections, laterals)
...
subroutine get_var_rank(c_var_name, rank) bind(C, name="get_var_rank")
   ...
   case("flowelemnode", "flowelemnbs", "flowelemlns", "flowelemcontour_x", "flowelemcontour_y")
      rank = 2
   case("pumps", "weirs", "orifices", "gates", "generalstructures", "sourcesinks", "dambreak", "observations", "crosssections", "laterals") ! Compound vars: shape = [numobj, numfields_per_obj]
      rank = 2
   end select
...
subroutine get_var(c_var_name, x) bind(C, name="get_var")
   ...
   case ("pumps", "weirs", "orifices", "gates", "generalstructures", "sourcesinks", "dambreak", "observations", "crosssections", "laterals")
