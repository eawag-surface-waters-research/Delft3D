...
proc startMormerge { inputfilename workdir mergeexe localrun runid node } {
   ...
   if {$platform == "linux"} {
      ...
      # win32
      set workdir [spaceSafe $workdir]
      set exedir [spaceSafe $exedir]
      set mergeexe [spaceSafe $mergeexe]
      set inputfilename [spaceSafe $inputfilename]
      set rundir [spaceSafe $rundir]
      ...
      if { $localrun } {
         ...
         set worksubdir [spaceSafe $worksubdir]
         set worksubsubdir [spaceSafe $worksubsubdir]
         set rootmergedir [spaceSafe $rootmergedir]
      ...
      puts $scriptfile "\nexit\n"
      puts $scriptfile "\nrem End of script\n"
      set workdir [spaceSafeRevert $workdir]
      set exedir [spaceSafeRevert $exedir]
      set mergeexe [spaceSafeRevert $mergeexe]
      set inputfilename [spaceSafeRevert $inputfilename]
      set rundir [spaceSafeRevert $rundir]
   }
   close $scriptfile
   ...
   if {$platform == "linux"} {
      ...
      # win32
      set sfilname [spaceSafe $sfilname]
      puts $shellscriptfile "@ echo off"
      puts $shellscriptfile "\nrem This script file is automatically generated by mormerge.tcl, version $version\n"
      puts $shellscriptfile "start /b $sfilname\n"
      set sfilname [spaceSafeRevert $sfilname]
   }
...
proc startFlow { inflist alist condition runids waveonline tdatomexe flowexe waveexe node } {
   ...
   if {$platform == "linux"} {
      ...
      set rootconddir        [spaceSafe $rootconddir]
      set flowhomedir        [spaceSafe $flowhomedir]
      set infillist(workdir) [spaceSafe $infillist(workdir)]
      set wavehomedir        [spaceSafe $wavehomedir]
      set swanbatdir         [spaceSafe $swanbatdir]
      set swanexedir         [spaceSafe $swanexedir]
      set waveexedir         [spaceSafe $waveexedir]
      set waveexe            [spaceSafe $waveexe]
      set flowexedir         [spaceSafe $flowexedir]
      set flowexe            [spaceSafe $flowexe]
      puts $scriptfile "@ echo off"
      puts $scriptfile "\nrem This script file is automatically generated by mormerge.tcl, version $version\n"
      puts $scriptfile "\nrem Set some environment parameters\n"
      ...
      if { $infillist(localrun) } {
         puts $scriptfile "\nrem Copy rundir data back to modeldir\n"
         puts $scriptfile "mkdir $rootconddir"
      ...
      puts $scriptfile "\nexit\n"
      puts $scriptfile "\nrem End of script\n"
      set rootconddir        [spaceSafeRevert $rootconddir]
      set flowhomedir        [spaceSafeRevert $flowhomedir]
      set infillist(workdir) [spaceSafeRevert $infillist(workdir)]
      set wavehomedir        [spaceSafeRevert $wavehomedir]
      set swanbatdir         [spaceSafeRevert $swanbatdir]
      set swanexedir         [spaceSafeRevert $swanexedir]
      set waveexedir         [spaceSafeRevert $waveexedir]
      set waveexe            [spaceSafeRevert $waveexe]
      set flowexedir         [spaceSafeRevert $flowexedir]
      set flowexe            [spaceSafeRevert $flowexe]
   }
   close $scriptfile
