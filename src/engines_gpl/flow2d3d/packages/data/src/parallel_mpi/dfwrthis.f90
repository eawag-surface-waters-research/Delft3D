subroutine dfwrthis(lundia    ,error     ,trifil    ,selhis    ,ithisc    , &
...
!
    ...
    if (nostatgl > 0) then
       ...
       call dfgather_filter(lundia, 2, size(xystat,2), nostatgl, 1, nostatgl, order_sta, xystat, rsbuff2, gdp )
       if (inode == master) then
