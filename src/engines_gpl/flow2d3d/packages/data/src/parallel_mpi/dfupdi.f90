subroutine dfupdi ( field, ks, ke, gdp )
!----- GPL ---------------------------------------------------------------------
!                                                                               
...
!
    ...
    !
    itag = 2
    call dfsendi ( field, work, worksize, ks, ke, request, itag, gdp )
    call dfwaiti ( field, work, worksize, ks, ke, request, itag, gdp )
    !
    deallocate(work)

end subroutine dfupdi
