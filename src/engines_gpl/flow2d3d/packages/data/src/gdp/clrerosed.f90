...
!
    ...
    if (associated(gdp%gderosed%sinkse))       deallocate(gdp%gderosed%sinkse      , STAT = istat)
    if (associated(gdp%gderosed%sourse))       deallocate(gdp%gderosed%sourse      , STAT = istat)
    if (associated(gdp%gderosed%sour_im))      deallocate(gdp%gderosed%sour_im     , STAT = istat)
