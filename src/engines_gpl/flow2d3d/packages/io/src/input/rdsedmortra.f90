...
!
    ...
    call setpardef(ipardef, rpardef, NPARDEF, -1, 3, gdp%gdmorpar%rdc)
    call setpardef(ipardef, rpardef, NPARDEF, -1, 4, gdp%gdmorpar%rdw)
    call setpardef(ipardef, rpardef, NPARDEF, -1, 5, gdp%gdmorpar%iopkcw)
    call setpardef(ipardef, rpardef, NPARDEF, -1, 6, gdp%gdmorpar%epspar)
