...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: compdmean.f90 47 2011-01-06 06:49:52Z jagers $
!  $HeadURL: http://svn.oss.deltares.nl/repos/opendelft3d/trunk/src/engines_gpl/flow2d3d/packages/kernel/src/compute_sediment/compdmean.f90 $
!!--description-----------------------------------------------------------------
!
