...
!
    ...
    integer     , dimension(5, norow)                                   :: irocol !  Description and declaration in esm_alloc_int.f90 then computation proceeds in the X-dir. If icx=1 then computation proceeds in the Y-dir.
