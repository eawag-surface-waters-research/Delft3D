...
!
    ...
    real(fp)     , dimension(gdp%d%nmlb:gdp%d%nmub)               , intent(in)  :: evap   !  Description and declaration in rjdim.f90
    ...
    real(fp)     , dimension(gdp%d%nmlb:gdp%d%nmub)               , intent(in)  :: soumud !  Description and declaration in rjdim.f90
    ...
    real(fp)     , dimension(gdp%d%nmlb:gdp%d%nmub, 0:kmax)       , intent(out) :: qzk    !  Description and declaration in rjdim.f90
    ...
    real(fp)     , dimension(gdp%d%nmlb:gdp%d%nmub, kmax)                       :: rttfu  !  Description and declaration in rjdim.f90
...
!
    ...
    call cucnp(dischy    ,icreep    ,dpdksi    ,s0        ,u0        , &
             ...
             & vnu2d     ,vicww     ,wsu       ,fxw       ,taubpu    ,taubsu    , &
