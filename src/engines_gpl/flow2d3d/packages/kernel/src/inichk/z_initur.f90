...
!
    ...
    real(fp), dimension(gdp%d%nmlb:gdp%d%nmub), intent(in) :: windv !  Description and declaration in rjdim.f90
    ...
    real(fp), dimension(gdp%d%nmlb:gdp%d%nmub, 0:kmax, ltur) :: rtur0 !  Description and declaration in rjdim.f90
