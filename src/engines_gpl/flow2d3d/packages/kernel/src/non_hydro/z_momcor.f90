...
!
    ...
    real(fp), dimension(gdp%d%nmlb:gdp%d%nmub)         , intent(in) :: dps !  Description and declaration in rjdim.f90
    ...
    real(fp), dimension(gdp%d%nmlb:gdp%d%nmub)                      :: s00 !  Description and declaration in rjdim.f90
