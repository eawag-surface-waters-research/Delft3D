...
!!
subroutine santoss(numrealpar, realpar ,par ,dzduu ,dzdvv , i2d3d, &
...
!
    ...
    character(len=256)              , intent(out)   :: message    !< not empty: echo and stop run
